// CurieSoftwareSerial - Version: Latest 
#include <SoftwareSerial.h>

// PS2Keyboard - Version: Latest 
#include <PS2Keyboard.h>

//////////////////////////////////////////////////////////////////////////
//             TinyBasic Plus + PS2 keyboard                            //
//       for VGA monitor output for arduino Leonardo                    // 
//////////////////////////////////////////////////////////////////////////
//
...
//
//Second Mod Author: Benjamin Nack <ben@nackfamily.com>
//
...
void loop()
{
  mySerial.println("with VGAx video output"); 
...
void setup()
{
  ...
  pinMode(11, OUTPUT);
#ifdef ARDUINO
  mySerial.begin(kConsoleBaud);	// opens serial port
  Serial.begin(9600);
  while( !mySerial ); // for Leonardo
